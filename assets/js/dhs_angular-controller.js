...
Author: Robert Santore
    ...
    8.0 CONTROLLER - DHS Welcom Dashboard 1
    9.0 CONTROLLER - DHS Dashboard 1
    10.0 CONTROLER - DHS Blank Page

    11.0 CONTROLER - DHS COMBINED TABLE WITH ALL EXTENSIONS

	12.0 CONTROLLER - UI Modal & Notifications
...
/* -------------------------------
   1.0 CONTROLLER - App
------------------------------- */
dhsAdminApp.controller('appController', ['$rootScope', '$scope', function($rootScope, $scope) {
...
/* -------------------------------
   2.0 CONTROLLER - Sidebar
------------------------------- */
dhsAdminApp.controller('sidebarController', function($scope, $rootScope, $state) {
    App.initSidebar();
});
...
/* -------------------------------
   3.0 CONTROLLER - Right Sidebar
------------------------------- */
dhsAdminApp.controller('rightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   4.0 CONTROLLER - Header
------------------------------- */
dhsAdminApp.controller('headerController', function($scope, $rootScope, $state) {
});

/* -------------------------------
   5.0 CONTROLLER - Top Menu
------------------------------- */
dhsAdminApp.controller('topMenuController', function($scope, $rootScope, $state) {
    setTimeout(function() {
        App.initTopMenu();
    }, 0);
});
...
/* -------------------------------
   6.0 CONTROLLER - Page Loader
------------------------------- */
dhsAdminApp.controller('pageLoaderController', function($scope, $rootScope, $state) {
    App.initPageLoad();
});
...
/* -------------------------------
   7.0 CONTROLLER - Theme Panel
------------------------------- */
dhsAdminApp.controller('themePanelController', function($scope, $rootScope, $state) {
    App.initThemePanel();
});
...
/* -------------------------------
   8.0 CONTROLLER - DHS Dashboard 1
------------------------------- */
dhsAdminApp.controller('DHSWelcomeController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {

if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            ajax:           "data/buildings.json",
            deferRender:    true,
            scrollY:        300,
            scrollCollapse: true,
            scroller:       true,
        ...
        nv.addGraph(function() {
            var pieChartData = [
                { 'label': 'Other', 			'value' : 62, 'color': blue },
                { 'label': 'Maintenance', 		'value' : 97, 'color': purple },
                { 'label': 'Under Repair', 		'value' : 43, 'color': orange },
                { 'label': 'LTR', 				'value' : 88, 'color': red },
                { 'label': 'Reserve', 			'value' : 26, 'color': green }
            ];
        ...
        nv.addGraph(function() {
            var stackedAreaChartData = [{
                ...
                'values' : [
                	...
                	[ 1225425600000 , 6.1382569939630] ,
                	[ 1228021200000 , 5.6434994016354] ,
                	[ 1230699600000 , 5.4952202625120] ,
    ...
    setTimeout(function() {
        $.gritter.add({
            title: 	'Robert, welcome to DSS CapApp!',
            text: 	'Robert, you have logged out or your session has expired. Use the login form to return to BCS',
            image: 	'assets/img/user-rbs.jpg',
			sticky: false,
			time: ''
        });
    }, 100);
...
/* -------------------------------
   9.0 CONTROLLER - DHS Dashboard
------------------------------- */
dhsAdminApp.controller('DHSDashboardController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   10.0 CONTROLER - DHS Blank Page
------------------------------- */
dhsAdminApp.controller('dhsStandardPageController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageMegaMenu = true;
});

/* -------------------------------
   11.0 CONTROLLER - DHS DETAIL
------------------------------- */
dhsAdminApp.controller('dhsStandardBuildingController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            dom: 'lBfrtip',
            buttons: [
...
/* -------------------------------
   11.0 CONTROLLER - DHS COMBINED TABLE WITH ALL EXTENSIONS
------------------------------- */
dhsAdminApp.controller('dhsTable1Controller', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            dom: 'lBfrtip',
            buttons: [
...
/* -------------------------------
   60.0 CONTROLLER - Login Logout
------------------------------- */
dhsAdminApp.controller('dhsLogoutController', function($scope, $rootScope, $state) {
    ...
    $scope.submitForm = function(form) {
        $state.go('app.dashboard.welcome');
    };
 ...
 /* Gritter Notification
    ...
    setTimeout(function() {
        $.gritter.add({
            title: 	'Robert, you have logged out!',
            text: 	'Robert, you have logged out or your session has expired. Use the login form to return to BCS',
            image: 	'assets/img/user-rbs.jpg',
			sticky: false,
			time: ''
...
/* -------------------------------
   10.0 CONTROLLER - Email Inbox v1
------------------------------- */
dhsAdminApp.controller('emailInboxController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   11.0 CONTROLLER - Email Inbox v2
------------------------------- */
dhsAdminApp.controller('emailInboxV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   12.0 CONTROLLER - UI Modal & Notifications
------------------------------- */
dhsAdminApp.controller('uiModalNotificationController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   12.0 CONTROLLER - Email Compose
------------------------------- */
dhsAdminApp.controller('emailComposeController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   13.0 CONTROLLER - Email Detail
------------------------------- */
dhsAdminApp.controller('emailDetailController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
});
...
/* -------------------------------
   15.0 CONTROLLER - UI Tree
------------------------------- */
dhsAdminApp.controller('uiTreeController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   16.0 CONTROLLER - UI Language Bar
------------------------------- */
dhsAdminApp.controller('uiLanguageBarIconController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageLanguageBar = true;
});
...
/* -------------------------------
   17.0 CONTROLLER - Form Plugins
------------------------------- */
dhsAdminApp.controller('formPluginsController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   18.0 CONTROLLER - Form Slider + Switcher
------------------------------- */
dhsAdminApp.controller('formSliderSwitcherController', function($scope, $rootScope, $state) {
    var green = '#00acac',
    red = '#ff5b57',
    blue = '#348fe2',
    purple = '#727cb6',
...
/* -------------------------------
   19.0 CONTROLLER - Form Validation
------------------------------- */
dhsAdminApp.controller('formValidationController', function($scope, $rootScope, $state) {
    $scope.submitForm = function(form) {
        if (!form.$valid) {
...
/* -------------------------------
   31.0 CONTROLLER - Table Manage Extension Combination: Buildings
------------------------------- */
dhsAdminApp.controller('tableManageBuildingsController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            dom: 'lBfrtip',
            buttons: [
...
/* -------------------------------
   29.0 CONTROLLER - Table Manage Scroller
------------------------------- */
dhsAdminApp.controller('tableManageScrollerController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            ajax:           "data/buildings.json",
            deferRender:    true,
...
/* -------------------------------
   20.0 CONTROLLER - Table Manage Default
------------------------------- */
dhsAdminApp.controller('tableManageDefaultController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            responsive: true
        });
...
/* -------------------------------
   21.0 CONTROLLER - Table Manage Autofill
------------------------------- */
dhsAdminApp.controller('tableManageAutofillController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            autoFill: true,
            responsive: true
...
/* -------------------------------
   22.0 CONTROLLER - Table Manage Buttons
------------------------------- */
dhsAdminApp.controller('tableManageButtonsController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            dom: 'Bfrtip',
            buttons: [
...
/* -------------------------------
   23.0 CONTROLLER - Table Manage ColReorder
------------------------------- */
dhsAdminApp.controller('tableManageColReorderController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            colReorder: true,
            responsive: true
...
/* -------------------------------
   24.0 CONTROLLER - Table Manage Fixed Columns
------------------------------- */
dhsAdminApp.controller('tableManageFixedColumnsController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            scrollY:        300,
            scrollX:        true,
...
/* -------------------------------
   25.0 CONTROLLER - Table Manage Fixed Header
------------------------------- */
dhsAdminApp.controller('tableManageFixedHeaderController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            lengthMenu: [20, 40, 60],
            fixedHeader: {
...
/* -------------------------------
   26.0 CONTROLLER - Table Manage KeyTable
------------------------------- */
dhsAdminApp.controller('tableManageKeyTableController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            scrollY: 300,
            paging: false,
...
/* -------------------------------
   27.0 CONTROLLER - Table Manage Responsive
------------------------------- */
dhsAdminApp.controller('tableManageResponsiveController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            responsive: true
        });
...
/* -------------------------------
   28.0 CONTROLLER - Table Manage RowReorder
------------------------------- */
dhsAdminApp.controller('tableManageRowReorderController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            responsive: true,
            rowReorder: true
...
/* -------------------------------
   30.0 CONTROLLER - Table Manage Select
------------------------------- */
dhsAdminApp.controller('tableManageSelectController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            select: true,
            responsive: true
...
/* -------------------------------
   31.0 CONTROLLER - Table Manage Extension Combination
------------------------------- */
dhsAdminApp.controller('tableManageCombineController', function($scope, $rootScope, $state) {
    if ($('#data-table').length !== 0) {
        $('#data-table').DataTable({
            dom: 'lBfrtip',
            buttons: [
    ...
    ------------------------- */
    $(".default-select2").select2();
    $(".multiple-select2").select2({ placeholder: "Choose Filter(s)..." });
...
/* -------------------------------
   32.0 CONTROLLER - Flot Chart
------------------------------- */
dhsAdminApp.controller('chartFlotController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   33.0 CONTROLLER - Morris Chart
------------------------------- */
dhsAdminApp.controller('chartMorrisController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   34.0 CONTROLLER - Chart JS
------------------------------- */
dhsAdminApp.controller('chartJsController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   35.0 CONTROLLER - Chart d3
------------------------------- */
dhsAdminApp.controller('chartD3Controller', function($scope, $rootScope, $state) {
...
/* -------------------------------
   36.0 CONTROLLER - Calendar
------------------------------- */
dhsAdminApp.controller('calendarController', function($scope, $rootScope, $state) {
	...
	var calendar = $('#calendar').fullCalendar({
		...
		events: [
			{
				title: 'Work Order 77892',
				start: new Date(y, m, 0),
				end: new Date(y, m, 1),
				className: 'bg-purple',
				media: '<i class="fa fa-list-alt"></i>',
				description: 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.'
			},
			{
				title: 'Work Order 23467 Review',
			...
			{
				title: 'Work Order 943211 Review',
...
/* -------------------------------
   37.0 CONTROLLER - Vector Map
------------------------------- */
dhsAdminApp.controller('mapVectorController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
dhsAdminApp.controller('mapGoogleController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
	...
	function initialize() {
		var mapOptions = {
			zoom: 13,
			center: new google.maps.LatLng(40.75, -73.9400),
    ...
    var turquoiseWaterStyles 	=	[
							...
							{"featureType":"landscape.man_made","elementType":"geometry.fill"},{"featureType":"road","elementType":"geometry","stylers":[{"lightness":100},{"visibility":"simplified"}]},
							{"featureType":"road","elementType":"labels","stylers":[{"visibility":"off"}]},
...
/* -------------------------------
   39.0 CONTROLLER - Gallery V1
------------------------------- */
dhsAdminApp.controller('galleryController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   40.0 CONTROLLER - Gallery V2
------------------------------- */
dhsAdminApp.controller('galleryV2Controller', function($scope, $rootScope, $state) {
	$('.superbox').SuperBox();
});
...
/* -------------------------------
   41.0 CONTROLLER - Page with Footer
------------------------------- */
dhsAdminApp.controller('pageWithFooterController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   42.0 CONTROLLER - Page without Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithoutSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   43.0 CONTROLLER - Page with Right Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithRightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   44.0 CONTROLLER - Page with Minified Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithMinifiedSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   45.0 CONTROLLER - Page with Two Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithTwoSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   46.0 CONTROLLER - Full Height Content
------------------------------- */
dhsAdminApp.controller('pageFullHeightContentController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   47.0 CONTROLLER - Page with Wide Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithWideSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   48.0 CONTROLLER - Page with Light Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithLightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   49.0 CONTROLLER - Page with Mega Menu
------------------------------- */
dhsAdminApp.controller('pageWithMegaMenuController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageMegaMenu = true;
});
...
/* -------------------------------
   50.0 CONTROLLER - Page with Top Menu
------------------------------- */
dhsAdminApp.controller('pageWithTopMenuController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   51.0 CONTROLLER - Page with Boxed Layout
------------------------------- */
dhsAdminApp.controller('pageWithBoxedLayoutController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   52.0 CONTROLLER - Page with Mixed Menu
------------------------------- */
dhsAdminApp.controller('pageWithMixedMenuController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageTopMenu = true;
});
...
/* -------------------------------
   53.0 CONTROLLER - Page Boxed Layout with Mixed Menu
------------------------------- */
dhsAdminApp.controller('pageBoxedLayoutWithMixedMenuController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageBoxedLayout = true;
    $rootScope.setting.layout.pageTopMenu = true;
});
...
/* -------------------------------
   54.0 CONTROLLER - Page with Transparent Sidebar
------------------------------- */
dhsAdminApp.controller('pageWithTransparentSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   55.0 CONTROLLER - Timeline
------------------------------- */
dhsAdminApp.controller('extraTimelineController', function($scope, $rootScope, $state) {
	var mapDefault;
...
/* -------------------------------
   56.0 CONTROLLER - Coming Soon
------------------------------- */
dhsAdminApp.controller('comingSoonController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.pageBgWhite = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   57.0 CONTROLLER - 404 Error
------------------------------- */
dhsAdminApp.controller('errorController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
});
...
/* -------------------------------
   58.0 CONTROLLER - Login V1
------------------------------- */
dhsAdminApp.controller('loginV1Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   59.0 CONTROLLER - Login V2
------------------------------- */
dhsAdminApp.controller('loginV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   60.0 CONTROLLER - Login Logout
------------------------------- */
dhsAdminApp.controller('loginLogoutController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
    $rootScope.setting.layout.pageBgWhite = true;
...
/* -------------------------------
   61.0 CONTROLLER - Register V3
------------------------------- */
dhsAdminApp.controller('registerV3Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
    $rootScope.setting.layout.pageBgWhite = true;
